...
Ansible Builder executes four stages when it runs your containerization tool to build a container image. The same four stages get executed if you build your container image with Podman or Docker from the containerfile and context generated by ``ansible-builder create``. These steps are:
- Base
- Galaxy
- Builder
- Final
